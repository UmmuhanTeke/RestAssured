...
public class _06_PathAndJsonPath {
    ...
    @Test
    public void extractingJsonPathIcObject() {
        ...
        //TODO  Bütün class yapısını yazmak zorundayız
        //TODO System.out.println("locationAsPathNesnesi = " + locationAsPathNesnesi);
        // bana sadece place dizisi lazım olsa bile, bütün diğer class ları yazmak zorundayım

        // TODO Eğer içerdeki bir nesne tipli parçayı (Burada Places) almak isteseydim
        List<Place> places = donenData.jsonPath().getList("places", Place.class);
        System.out.println("places = " + places);

        // TODO Sadece Place dizisi lazım ise diğerlerini yazmak zorunda değilsin.
